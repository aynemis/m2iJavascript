    ...
    document.getElementById("navbar").innerHTML = `
       <nav class="navbar navbar-expand-lg navbar-custom shadow-sm" style="background-color: #006400;">
            <div class="container-fluid">
                <a class="navbar-brand font-weight-bold text-uppercase d-flex align-items-center" href="../home/index.html" style="font-size: 1.8rem; color: #d4edda;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto align-items-center">
                        <li class="nav-item mx-3">
                            <a class="nav-link text-light font-weight-bold" href="../home/index.html" style="transition: color 0.3s ease;">Accueil</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link text-light font-weight-bold" href="../transfers/index.html" style="transition: color 0.3s ease;">Historique</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link text-light font-weight-bold" href="../user/index.html" style="transition: color 0.3s ease;">Profil</a>
                        </li>
                    </ul>
